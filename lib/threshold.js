 ...
 * when either image is ambiguous there. See computeDefect in compare.js.
 */
...
function thresholdForeground(gray, width, height, cfg) {
	...
	const level = cfg.thresholdMode === "otsu" ? otsuThreshold(gray) : cfg.threshold;
	return {
...
module.exports = { otsuThreshold, thresholdForeground };
